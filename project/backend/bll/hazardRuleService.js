...
const hazardRuleService = {
  ...
  async importSeedPack() {
    ...
    for (const seed of HAZARD_RULE_SEED_PACK) {
      ...
      const evidenceCategoryIds = (seed.evidence_category_names || [])
        .map((name) => categoryMap.get(name))
        .filter(Boolean)
      const matchedClauses = await hazardRuleDal.searchVerifiedClausesForSeed({
        category_id: categoryId,
        category_ids: evidenceCategoryIds,
        keywords: seed.clause_keywords,
        required_keywords: seed.required_clause_keywords || [],
        preferred_sources: seed.preferred_sources || [],
        limit: seed.max_clause_refs || 2,
      })
...
const HAZARD_RULE_SEED_PACK = [
  {
    ...
    preferred_sources: ['中华人民共和国消防法', '重大火灾隐患判定规则', '公众聚集场所投入使用营业消防安全检查规则'],
    max_clause_refs: 2,
  ...
  },
  {
    ...
    preferred_sources: ['中华人民共和国消防法', '公众聚集场所投入使用营业消防安全检查规则'],
    max_clause_refs: 2,
  ...
  },
  {
    ...
    required_clause_keywords: ['灭火器'],
    preferred_sources: ['公众聚集场所投入使用营业消防安全检查规则', '手提式灭火器', 'GB 4351'],
    max_clause_refs: 1,
  ...
  },
  {
    ...
    preferred_sources: ['消防应急照明和疏散指示系统', 'GB 17945', '公众聚集场所投入使用营业消防安全检查规则'],
    max_clause_refs: 2,
  ...
  },
  {
    ...
    preferred_sources: ['防火门', 'GB 12955', '公众聚集场所投入使用营业消防安全检查规则'],
    max_clause_refs: 2,
  ...
  },
  {
    ...
    clause_keywords: ['安全帽', '劳动防护用品', '佩戴', '使用'],
    required_clause_keywords: ['佩戴'],
    preferred_sources: ['中华人民共和国安全生产法'],
    evidence_category_names: ['职业健康与劳动安全', '工贸行业安全'],
    max_clause_refs: 2,
  ...
  },
  {
    ...
    preferred_sources: ['高处作业分级', 'GB 3608', '坠落防护 安全带', 'GB 6095'],
    max_clause_refs: 2,
  ...
  },
  {
    ...
    required_clause_keywords: ['有限空间'],
    preferred_sources: ['有限空间作业安全技术规范', 'GB 46768', '工贸企业重大事故隐患判定标准'],
    evidence_category_names: ['职业健康与劳动安全'],
    max_clause_refs: 2,
  ...
  },
  {
    ...
    preferred_sources: ['特种设备重大事故隐患判定准则', 'GB 45067'],
    max_clause_refs: 2,
